...
#define PQ_APP_ALGNAME PQCLEAN_MLKEM768_CLEAN_CRYPTO_ALGNAME
#define PQ_APP_PUBLICKEYBYTES PQCLEAN_MLKEM768_CLEAN_CRYPTO_PUBLICKEYBYTES
#define PQ_APP_SECRETKEYBYTES PQCLEAN_MLKEM768_CLEAN_CRYPTO_SECRETKEYBYTES
#define PQ_APP_CIPHERTEXTBYTES PQCLEAN_MLKEM768_CLEAN_CRYPTO_CIPHERTEXTBYTES
#define PQ_APP_BYTES PQCLEAN_MLKEM768_CLEAN_CRYPTO_BYTES
#define pq_app_kem_keypair PQCLEAN_MLKEM768_CLEAN_crypto_kem_keypair
#define pq_app_kem_enc PQCLEAN_MLKEM768_CLEAN_crypto_kem_enc
#define pq_app_kem_dec PQCLEAN_MLKEM768_CLEAN_crypto_kem_dec
