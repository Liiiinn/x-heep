...
#define PQ_APP_ALGNAME PQCLEAN_MLDSA44_CLEAN_CRYPTO_ALGNAME
#define PQ_APP_PUBLICKEYBYTES PQCLEAN_MLDSA44_CLEAN_CRYPTO_PUBLICKEYBYTES
#define PQ_APP_SECRETKEYBYTES PQCLEAN_MLDSA44_CLEAN_CRYPTO_SECRETKEYBYTES
#define PQ_APP_SIGNATUREBYTES PQCLEAN_MLDSA44_CLEAN_CRYPTO_BYTES
#define pq_app_sign_keypair PQCLEAN_MLDSA44_CLEAN_crypto_sign_keypair
#define pq_app_sign_signature PQCLEAN_MLDSA44_CLEAN_crypto_sign_signature
#define pq_app_sign_verify PQCLEAN_MLDSA44_CLEAN_crypto_sign_verify
