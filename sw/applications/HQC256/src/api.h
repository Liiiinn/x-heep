...
#define HQC_CRYPTO_ALGNAME PQCLEAN_HQC256_CLEAN_CRYPTO_ALGNAME
#define HQC_CRYPTO_SECRETKEYBYTES PQCLEAN_HQC256_CLEAN_CRYPTO_SECRETKEYBYTES
#define HQC_CRYPTO_PUBLICKEYBYTES PQCLEAN_HQC256_CLEAN_CRYPTO_PUBLICKEYBYTES
#define HQC_CRYPTO_BYTES PQCLEAN_HQC256_CLEAN_CRYPTO_BYTES
#define HQC_CRYPTO_CIPHERTEXTBYTES PQCLEAN_HQC256_CLEAN_CRYPTO_CIPHERTEXTBYTES

#define hqc_crypto_kem_keypair PQCLEAN_HQC256_CLEAN_crypto_kem_keypair
#define hqc_crypto_kem_enc PQCLEAN_HQC256_CLEAN_crypto_kem_enc
#define hqc_crypto_kem_dec PQCLEAN_HQC256_CLEAN_crypto_kem_dec
