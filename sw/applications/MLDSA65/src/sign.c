...
typedef struct {
    ...
    polyveck t1, w1, h;
    shake256incctx state;
} mldsa_verify_scratch_t;

static union {
    mldsa_keypair_scratch_t keypair;
    mldsa_sign_scratch_t sign;
    mldsa_verify_scratch_t verify;
} mldsa_scratch;
...
#define seedbuf (mldsa_scratch.keypair.seedbuf)
#define tr (mldsa_scratch.keypair.tr)
#define mat (mldsa_scratch.keypair.mat)
#define s1 (mldsa_scratch.keypair.s1)
#define s1hat (mldsa_scratch.keypair.s1hat)
#define s2 (mldsa_scratch.keypair.s2)
#define t1 (mldsa_scratch.keypair.t1)
#define t0 (mldsa_scratch.keypair.t0)
...
int PQCLEAN_MLDSA65_CLEAN_crypto_sign_signature_ctx(uint8_t *sig,
    ...
    uint16_t nonce = 0;
#define seedbuf (mldsa_scratch.sign.seedbuf)
#define mat (mldsa_scratch.sign.mat)
#define s1 (mldsa_scratch.sign.s1)
#define y (mldsa_scratch.sign.y)
#define z (mldsa_scratch.sign.z)
#define t0 (mldsa_scratch.sign.t0)
#define s2 (mldsa_scratch.sign.s2)
#define w1 (mldsa_scratch.sign.w1)
#define w0 (mldsa_scratch.sign.w0)
#define h (mldsa_scratch.sign.h)
#define cp (mldsa_scratch.sign.cp)
#define state (mldsa_scratch.sign.state)
...
int PQCLEAN_MLDSA65_CLEAN_crypto_sign_verify_ctx(const uint8_t *sig,
        ...
        const uint8_t *pk) {
    unsigned int i;
#define buf (mldsa_scratch.verify.buf)
#define rho (mldsa_scratch.verify.rho)
#define mu (mldsa_scratch.verify.mu)
#define c (mldsa_scratch.verify.c)
#define c2 (mldsa_scratch.verify.c2)
#define cp (mldsa_scratch.verify.cp)
#define mat (mldsa_scratch.verify.mat)
#define z (mldsa_scratch.verify.z)
#define t1 (mldsa_scratch.verify.t1)
#define w1 (mldsa_scratch.verify.w1)
#define h (mldsa_scratch.verify.h)
#define state (mldsa_scratch.verify.state)
